...
<BODY>
		...
		<TBODY>
			<TR vAlign=center>
				<TD style="PADDING-LEFT: 8px; WIDTH: 137px" vAlign=top noWrap
					width="100%"><IMG height="46" alt="到搜索首页"
					src="img/3.png" width=137 border=0></TD>
				<TD>&nbsp;&nbsp;&nbsp;</TD>
							...
							<TR>
								<TD vAlign="top" noWrap>
									<form action="searchIndex.do">
										<input type="text" name="fieldname" size="42" value="${queryStr}"
											maxlength="100" /> <input type="submit" value="搜吧============" />
									</form>
								</TD>
	...
	<c:forEach items="${rlist}" var="eachdoc">
		<TABLE cellSpacing=5 cellPadding=0 border=0>
			<TBODY>
				<TR>
					<TD class="f EC_PP"><A href="${eachdoc.fileUrl}"
						target=_blank>${eachdoc.filename} </A> 
						<BR>${eachdoc.contents}<BR>
					</TD>
				</TR>
			</TBODY>
		</TABLE>
	...
	<DIV id=ft>
		<span>Copyright © &copy; 1956 - 2016&nbsp; All Rights Reserved 电子科技大学</span>
	</DIV>
