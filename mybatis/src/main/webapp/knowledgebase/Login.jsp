...
<html>
<head>
<link rel="stylesheet" href="/mybatis/knowledgebase/css/bootstrap.min.css">
<script src="/mybatis/knowledgebase/js/jquery.min.js"></script>
<script src="/mybatis/knowledgebase/js/jquery.cookie.min.js"></script>
	...
	<div class="login">
		...
		<div class="login-mid">
			...
			<form action="/mybatis/UserInfoController/login.do" method="post">
				...
				<input type="button" class="btn btn-primary" value="注册" style="float:right;" onclick="window.open('/mybatis/knowledgebase/Register.jsp','_self')">
				</div>
				</form>
     		</div>
		</div>
