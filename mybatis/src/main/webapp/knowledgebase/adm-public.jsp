                    ...
                    <div id="source-manage" class="panel-collapse collapse in">
                        <div class="panel-body" style="padding: 6px 15px;">
                            <ul class="nav nav-pills nav-stacked"
                                ...
                                <li class="active"><a href="/mybatis/knowledgebase/adm-public.jsp">公有文件</a></li>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="downloadFile(this)">是
                </button>
            </div>
        </div>
    </div>
