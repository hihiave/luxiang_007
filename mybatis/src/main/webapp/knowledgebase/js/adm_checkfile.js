...
function get_all_checkfile_table(data){
    ...
    for(var i = 0;i < checkfile.length;i++){
        ...
        var td_2 = "<td style='padding-top:15px;' id="+checkfile[i].fileId+"><a href='../"+checkfile[i].fileUrl+"'  target='_blank'>"+checkfile[i].fileName+"</a></td>";
        ...
        var td_4 = "<td style='text-align:center;'><button class='button button-action" +
        		" button-rounded button-small changefilemsg' onclick='changeFileInfo(this)'>修改信息</button></td>";
        ...
        var content = tr_begin + td_1 + td_2 +td_5 + td_4 + td_3 + tr_end;
