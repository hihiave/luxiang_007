...
function cb_get_all(obj){
    ...
    for(var each in all_wait_file){
        ...
        var tr_end = "</tr>";
        var td_1 = "<td style='padding-top:15px;'><input type='checkbox' name='checkAll' value="+all_wait_file[each].fileId+"></td>";
        var td_2 = "<td style='padding-top:15px;' value="+all_wait_file[each].fileId+">"+all_wait_file[each].fileName+"</td>";
