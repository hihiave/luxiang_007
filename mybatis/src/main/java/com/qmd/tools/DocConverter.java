	...
	private void doc2pdf() throws Exception {
		if(docFile.exists()){
			if(!pdfFile.exists()){
				...
				String command=officeHome+"soffice.exe -headless -accept=\"socket,host=127.0.0.1,port=8100;urp;\" -nofirststartwizard";
